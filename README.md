...
├── ingest.py             # Independent script for video data extraction
├── memory.py             # Independent script for Vector DB testing/indexing
├── agent.py              # CLI-based RAG Chat Agent
├── requirements.txt      # Project dependencies
├── .gitignore            # Security: Prevents leaking API keys & local data
...
Modular Design: The project is separated into logic-specific files (ingest, memory, agent) to allow for easy debugging and scaling.
...
[ ] Support for local PDF and Document ingestion.

[ ] Exporting AI-generated insights to PDF/Markdown.

Developed by Sourav Mondal. Exploring the intersection of LLMs and Vector Search.
